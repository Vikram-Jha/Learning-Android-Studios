...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    //view holder class could be created separately or can be created here as well
    //It holds all the view from our card (it hold all the view from the card hence viewholder)
